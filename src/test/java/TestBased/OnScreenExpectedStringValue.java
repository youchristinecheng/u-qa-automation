...
public class OnScreenExpectedStringValue {
    ...
    public static final String LimitedHomePageSGTitle = "Welcome";
    ...
    public static final String ActiveCardSGConfirmEmailPageTitle = "Confirm Email Address";
    public static final String ActiveCardSGCheckEmailPageTitle = "Check Your Email";
    public static final String ActiveCardSGCreatePINPageTitle = "Create a PIN";
    public static final String ActiveCardSGCreatePINPageSummary = "For both unlocking the app and using the card in ATM";
    public static final String ActiveCardSGConfirmPINPageTitle = "Confirm Your PIN";
